                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nomeGuerra" type="text" class="form-control{{ $errors->has('nomeGuerra') ? ' is-invalid' : '' }}" name="nomeGuerra" value="{{ old('nomeGuerra') }}" required autofocus>

                                @if ($errors->has('nomeGuerra'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('nomeGuerra') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
