					...
					<form class="form-horizontal" action="{{ route('register') }}"
						...
						<div class="form-row">
							...
							<div class="form-group col-md-2">
								<label for="postograd_id">Posto/Grad</label> <select class="form-control" id="postograd_id" name="postograd_id">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-5 offset-md-2">
								<label for="funcoe_id">Função</label> <select	class="form-control" id="funcoe_id" name="funcoe_id">
