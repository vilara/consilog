					...
					<table class="table">
						...
						<tbody align="center">
							...
							<tr>
								...
								<td><a href="{{ url('/latlongs/create/'.$end->id) }}" style="color: red;" title="Inserir localização"><i class="fas fa-globe-americas"  style="color: red;"></i></a></td>
								@else
								...
								@endif
								@empty
								<td><i class="fas fa-globe-americas"  style="color: red;" title="Favor inserir endereço inicialmente"></i></td>
								 @endforelse
